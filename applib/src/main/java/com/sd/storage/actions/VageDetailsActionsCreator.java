...
public class VageDetailsActionsCreator extends ActionsCreator {
    ...
    public void getVeveDetails(String vegeid,String userid) {
        ...
        putObsToSubscriber(mApiService.getVageDetails(params), new CallBack<DataContainer<ArrayList<VageModel>>>(this) {
            @Override
    ...
    public void getCommentList(String vegeid) {
        ...
        HashMap<String, String> params = new HashMap<>();
        params.put("vegeid",vegeid);
        putObsToSubscriber(mApiService.getCommentList(params), new CallBack<DataContainer<ArrayList<VageModel>>>(this) {
            @Override
            protected void doNext(DataContainer<ArrayList<VageModel>> weekMeunModelDataContainer) {

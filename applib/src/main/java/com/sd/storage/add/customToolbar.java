...
//            });
    ...
    public void setView(Context context) {
        inflate(context, R.layout.layout_cus_tool_bar, this);
        tvTitle = (TextView) findViewById(R.id.tv_custitle);
        tvRight = (TextView) findViewById(R.id.tv_cusright);
        tvLeft = (TextView) findViewById(R.id.tv_cusleft);
    }

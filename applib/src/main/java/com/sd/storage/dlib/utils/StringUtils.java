...
public class StringUtils {
	...
	public static boolean isBlank(final CharSequence cs) {
		int strLen;
		if (cs == null || "null".equals(cs)|| (strLen = cs.length()) == 0) {
			return true;
		}
	...
	/**
	 * <p>
	 * Checks if any one of the CharSequences are blank ("") or null and not
	 * whitespace only..
	 * </p>
	 *
	 * <pre>
	...
	private static double score(final CharSequence first, final CharSequence second) {
		...
		final double dist = (m1.length() / ((double) shorter.length()) + m2.length() / ((double) longer.length()) + (m1
...
public static boolean isMobileNo(String mobiles) {  
   ...
   */  
	 ...
	 * @return
	 */
	public static String replacePhone(String mobile) {

...
public class VageSearchAdapter extends RecyclerView.Adapter<VageSearchAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public VageSearchAdapter(Context context) {

...
public class WorkLeaveApplyFragment extends CommonFragment{
    ...
    public List<CommonFragment.Group> getGroupList() {
        ...
        baseHolder.add(new HandInputGroup.Holder("申请类型",true,false,"事假申请",HandInputGroup.VALUE_TYPE.TEXTFILED).setEditable(false).setColor(Color.rgb(170,170,170)));
        ...
        baseHolder.add(new HandInputGroup.Holder("",false,false,"", HandInputGroup.VALUE_TYPE.EMPTY_SPACE));
        baseHolder.add(new HandInputGroup.Holder("事由",true,false,"/请输入事假申请事由",HandInputGroup.VALUE_TYPE.BIG_EDIT));
        baseHolder.add(new HandInputGroup.Holder("",false,false,"", HandInputGroup.VALUE_TYPE.EMPTY_SPACE));
...
//                        String department = getDisplayValueByKey("部门").getRealValue();

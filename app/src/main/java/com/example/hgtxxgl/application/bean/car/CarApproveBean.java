...
public class CarApproveBean {
    ...
    private List<ApiAppoveCarLeaveBean> Api_Appove_CarLeave;

    public List<ApiAppoveCarLeaveBean> getApi_Appove_CarLeave() {
        return Api_Appove_CarLeave;
    }

    public void setApi_Appove_CarLeave(List<ApiAppoveCarLeaveBean> Api_Appove_CarLeave) {
        this.Api_Appove_CarLeave = Api_Appove_CarLeave;
    }

    public static class ApiAppoveCarLeaveBean {
        /**
         * ActualInTime :
         * ActualOutTime :

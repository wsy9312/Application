...
//Api_Retract_CarLeave
//车辆外出撤销申请

public class CarLeaveDetailRetractBean {

    private List<ApiRetractCarLeaveBean> Api_Retract_CarLeave;

    public List<ApiRetractCarLeaveBean> getApi_Retract_CarLeave() {
        return Api_Retract_CarLeave;
    }

    public void setApi_Retract_CarLeave(List<ApiRetractCarLeaveBean> Api_Retract_CarLeave) {
        this.Api_Retract_CarLeave = Api_Retract_CarLeave;
    }

    public static class ApiRetractCarLeaveBean {
        /**
         * ActualInTime :
         * ActualOutTime :

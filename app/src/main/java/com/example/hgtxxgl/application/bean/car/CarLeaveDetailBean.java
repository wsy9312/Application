...
//Api_Get_MyApplyForCar
//得到我的申请(车辆)

public class CarLeaveDetailBean {

    private List<ApiGetMyApplyForCarBean> Api_Get_MyApplyForCar;

    public List<ApiGetMyApplyForCarBean> getApi_Get_MyApplyForCar() {
        return Api_Get_MyApplyForCar;
    }

    public void setApi_Get_MyApplyForCar(List<ApiGetMyApplyForCarBean> Api_Get_MyApplyForCar) {
    ...
    public static class ApiGetMyApplyForCarBean {
        ...
        public String toString() {
            return "ApiGetMyApplyForCarBean{" +

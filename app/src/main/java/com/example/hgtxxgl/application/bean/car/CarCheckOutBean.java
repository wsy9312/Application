...
public class CarCheckOutBean {

    private List<ApiEditCheckOutForCarBean> Api_Edit_CheckOutForCar;

    public List<ApiEditCheckOutForCarBean> getApi_Edit_CheckOutForCar() {
        return Api_Edit_CheckOutForCar;
    }

    public void setApi_Edit_CheckOutForCar(List<ApiEditCheckOutForCarBean> Api_Edit_CheckOutForCar) {
        this.Api_Edit_CheckOutForCar = Api_Edit_CheckOutForCar;
    }

    public static class ApiEditCheckOutForCarBean {
        /**
         * ActualInTime :
         * ActualOutTime :

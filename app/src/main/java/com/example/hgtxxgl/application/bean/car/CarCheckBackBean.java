...
public class CarCheckBackBean {

    private List<ApiEditCheckBackForCarBean> Api_Edit_CheckBackForCar;

    public List<ApiEditCheckBackForCarBean> getApi_Edit_CheckBackForCar() {
        return Api_Edit_CheckBackForCar;
    }

    public void setApi_Edit_CheckBackForCar(List<ApiEditCheckBackForCarBean> Api_Edit_CheckBackForCar) {
        this.Api_Edit_CheckBackForCar = Api_Edit_CheckBackForCar;
    }

    public static class ApiEditCheckBackForCarBean {
        /**
         * ActualInTime :
         * ActualOutTime :

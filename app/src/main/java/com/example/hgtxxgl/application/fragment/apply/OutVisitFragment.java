...
public class OutVisitFragment extends CommonFragment {
    ...
    public static OutVisitFragment newInstance() {
        OutVisitFragment fragment = new OutVisitFragment();
        return fragment;
    }

    public static OutVisitFragment newInstance(Bundle bundle) {
        OutVisitFragment fragment = new OutVisitFragment();
...
//        }
        ...
        baseHolder.add(new HandInputGroup.Holder("被访人",true,false,"/请填写",HandInputGroup.VALUE_TYPE.TEXTFILED));
        baseHolder.add(new HandInputGroup.Holder("被访人单位",true,false,"/自动读取",HandInputGroup.VALUE_TYPE.TEXTFILED).setEditable(false));
        baseHolder.add(new HandInputGroup.Holder("来访时间",true,false,"/自动读取",HandInputGroup.VALUE_TYPE.TEXTFILED).setEditable(false));
        baseHolder.add(new HandInputGroup.Holder("拟进入时间",false,false,"/请选择",HandInputGroup.VALUE_TYPE.DATE));
        baseHolder.add(new HandInputGroup.Holder("拟离开时间",true,false,"/请选择",HandInputGroup.VALUE_TYPE.DATE));
        baseHolder.add(new HandInputGroup.Holder("到访地点",true,false,"/请选择",HandInputGroup.VALUE_TYPE.SELECT));
        ...
        List<HandInputGroup.Holder> holder1 = new ArrayList<>();

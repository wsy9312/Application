...
public class CircleTextImage extends ImageView {
    ...
    protected int[] mColors = {0xFF3497FC, 0xFF6495ED, 0xFFE32636, 0xFF800000, 0xFF808000, 0xFFFF8C69, 0xFF808080,
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.circletextview_circle_color, mColors[0]);
